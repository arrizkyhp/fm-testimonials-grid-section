...
export default function handler(
  req: NextApiRequest,
  res: NextApiResponse<DataTestimonialsType>
) {
    ...
    payload: {
      ...
      items: [
        ...
        },
        {
          ...
          testimonial:
            ' started as a total newbie with virtually no coding skills. I now work as a mobile engineer for a big company. This was one of the best investments I’ve made in myself.',
        },
        {
          id: 3,
          type: 'white',
      ...
      attribution: {
        ...
        url: 'https://github.com/arrizkyhp',
      },
    },
  });
}
